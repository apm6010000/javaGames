...
//import javax.swing.JOptionPane;	//测试使用
...
public class FindExpression {
	...
	/**
	 * 测试使用 ** public static void main(String[] args) { FindExpression s=new
	 * FindExpression(); s.setNumbers(new int[]{2,4,6,8}); String[]
	 * output=s.getExpression(); for (int i=0; i<output.length; i++) {
					...
					for (int c2 = 0; c2 < 6; c2++) {
						for (int c3 = 0; c3 < 6; c3++) {
							if ((c1 / 3 == c2 / 3 && (c1 % 3) * (c2 % 3) != 0)
									...
									|| (c1 / 3 == c3 / 3
											&& (c1 % 3) * (c3 % 3) != 0 && t2 == 2)) { // 去除连减连除的解,因为x/(y/z)=x*z/y
								continue;
							}
							n1 = cal1(n, t1, c1);
							n2 = cal2(n1, t2, c2);
